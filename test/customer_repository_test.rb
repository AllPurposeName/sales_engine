...
#     test_customer_repo = CustomerRepository.new
#   end
#
...
#     test_case_repo = CustomerRepository.new("./data/customers_simple_sample.csv")
#     result = ["1","Joey","Ondricka","2012-03-27 14:54:09 UTC",
#       "2012-03-27 14:54:09 UTC"]
#       assert_equal result, test_case_repo.csv_parse
#   end
#
